"""
Comandos de operación: hablarle, servirla, medirla.

Chat, habilidades, Salón web, tareas del planificador, benchmark de memoria,
comprobación de Vertex y el daemon. Son los que arrancan cosas o salen a la
red — por eso ninguno se ejecuta en la suite.
"""
...
from ..memory.fts5_memory import FTS5MemoryEngine
