...
- **Herramientas Nous Portal:** Utiliza el gateway unificado de Nous Portal (`src/tools/nous_portal.py`) para consumir FAL (imágenes), TTS (voz) y Firecrawl (web).
...
3. **Optimización de Tokens:** Para clasificaciones o formateos de texto secundarios, apóyate en el modelo rápido configurado en `provider_routing`; reserva el modelo principal para tareas creativas y de síntesis.
